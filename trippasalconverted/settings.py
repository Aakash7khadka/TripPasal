"""
Django settings for trippasalconverted project.
...
SECRET_KEY = 'q!e81z&&()p_hcn3+=wii4e2ciz5ln@_)+^)h&!&r%js^avp2v'
...
WSGI_APPLICATION = 'trippasalconverted.wsgi.application'
